...
{% block content %}
  <div class="container">
    ...
    <p>
      This Privacy Policy was last modified on Nov 19, 2015.
    </p>

    <p>
      {{ appName }} ("us", "we", or "our") operates {{ baseUrl }} (the "Site"). This page informs you of our policies regarding the collection, use and disclosure
...
its absolute security.
    ...
    <p>
      {{ appName }} may update this Privacy Policy from time to time. We will notify
...
Privacy Policy periodically for any changes.
    ...
    <h2>Contact Us</h2>
    <p>
If you have any questions about this Privacy Policy, please contact us at <code>{{ emailAddress }}</code>
    </p>
  </div>
{% endblock %}
